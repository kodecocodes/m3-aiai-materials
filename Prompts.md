...
Users can see one clue for a maximum time of 20 seconds. Once the timer expires - the next clue is shown automatically. Users can’t go back to see the previous clue. The idea is users will have to read the clues in this time and also remember them to make the guess. The point system changes now.

It will be 40 (end of 1st clue), 30 (end of 2nd clue), 20 (end of 3rd clue), 10 (end of 4th clue). In this mode, the users get an opportunity to score more points. Maximum points for each round will be 40 now (instead of 20 in standard mode).
```
